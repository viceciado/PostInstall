        ...
        $FixPermissionsButton.Add_Click({
            ...
            if ($selectedFolders.Count -eq 0) {
                do {
                    ...
                    if ($folderBrowserDialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) {
                        ...
                        $addMore   = Show-MessageDialog -Title "Limpeza de permiss̵es" -Message $message -MessageType "Question" -Buttons "YesNo"
            ...
            if ($selectedFolders.Count -gt 0) {
                ...
                elseif ($cleanNowOrLater -eq "No") {
                    ...
                    if ($created -eq $true) {
                        Show-Notification -Title "Limpeza de permiss̵es" -Message "A tarefa foi criada com sucesso"
                        $global:ScriptContext.Config.PersistedSelectedFolders = @()
                    }
                    else {
