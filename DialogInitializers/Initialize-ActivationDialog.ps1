function Get-ActivationDialogConfiguration {
    <#
    .SYNOPSIS
        Retorna o ScriptBlock de configuração do diálogo ActivationDialog.
    #>
    return {
        ...
        # Se já existe chave OEM carregada, pré-configurar interface
        ...
        $activateOemButton.Add_Click({
                ...
                try {
                    ...
                    if ($licenseInfo -and $licenseInfo.LicenseStatus -eq $licensedStatus) {
                        ...
                        $msg = "Falha ao ativar o Windows usando a chave OEM. Status atual da licença: $currentStatus. A chave foi copiada para a área de transferência. Tente ativar manualmente."
